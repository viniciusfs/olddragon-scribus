...
replace_data() {
	...
	${SED_CMD} -i 's/%VAR_titulo%/Título Aventura/g' ${AVENTURA_OUTPUT}
	...
	${SED_CMD} -i 's/%VAR_titulo%/Título Material/g' ${SUPLEMENTO_OUTPUT}
...
pack() {
	${ZIP_CMD} ${PACKAGE_NAME} ${AVENTURA_OUTPUT} ${SUPLEMENTO_OUTPUT} images/*
}
